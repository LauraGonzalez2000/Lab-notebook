...
from utils_.contrast_angle_sensitivity_methods import\
                compute_tunings,compute_tunings2
...
Tuning = compute_tuning_response_per_cells(data=data, Episodes=Episodes,
...
fig, ax = plot_responsiveness(['WT_contrast-1.0', 
                        'WT_contrast-0.5'],
                        average_by=average_by, #issue !!  #not average by subject
                        path=tempfile.tempdir, 
                        colors = colors)
#%%